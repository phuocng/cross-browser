...
With the same reason of [prefixing CSS](https://phuoc.ng/collection/cross-browser-compatible/css-vendor-prefixes) properties, the browsers also prefix JavaScript APIs in the experimental phase.
...
-   [CSS vendor prefixes](https://phuoc.ng/collection/cross-browser-compatible/css-vendor-prefixes)
